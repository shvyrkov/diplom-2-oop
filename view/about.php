...
<div class="container ">
    <div class="block2">
        ...
        <!-- <div>
            @TODO: Цифрой обозначается количество карточек с методами и интрументами внутри этапа.
        </div> -->
        <br>
        <div class="Atxt4">
    ...
    <div class="block3">
        ...
        <br>
        <!-- <div class="Atxt14">
                @TODO: <b>Историческая справка.</b> Указание как и где появился этот метод или инструмент, кто авторы и как он развивался.
            </div>
            <br> -->
        <!-- <div class="Atxt15">
                @TODO: <b>Файлы и документы для скачивания.</b> Модератор может загружать полезные на его взгляд материалы: статьи, инструкции, шаблоны, руководства, слайды для проведения..
            </div>
            <br> -->
        <!-- <div class="Atxt16">
                @TODO: <b>Ссылки на другие ресурсы и источники.</b> Сегодня в интернете есть много авторского контента и видео-роликов, сообщества и даже фирменные сайты по методам и инструментам.
            </div>
            <br> -->
        <!-- <div class="Atxt17">
                @TODO: <b>Фотографии и изображения.</b> Полезный визуальный контент для работы или понимания методики или примеры, как это делать...
            </div> -->
    ...
    <div class="block4">
        ...
        <div class="Atxt24">
            ...
            <!-- @TODO: Может отмечать карточки с методами и собирать свою ленту методов и интрументов. <br> -->
...
<script src="/js/chunk-vendors.993467c2.js"></script>
<script src="/js/app.e1910066.js"></script>
<script>
    ...
    <div><img src=https://mc.yandex.ru/watch/56122855 style="position:absolute; left:-9999px;" alt=""></div>
</noscript>
<!-- </body> -->
<?php
